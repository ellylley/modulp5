            ...
            <div class="card">
                <div class="card-content">
                    ...
                    <div class="card-footer d-flex justify-content-between">
                        <a href="<?= base_url('home/word/'.$gou->id_modul) ?>" class="btn btn-light-secondary">
                            Print
                        </a>
                        <a href="<?= base_url('home/editmodul/'.$gou->id_modul) ?>">
                            <button class="btn btn-light-primary">Edit</button>
                        </a>
                    </div>
