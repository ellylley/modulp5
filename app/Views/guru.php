        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title" align="center">Daftar Guru</h4>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered mb-0">
                            ...
                            <tbody>
                                ...
                                $no = 1;
                                foreach ($elly as $gou) {
                                    if ($gou->level == 2 || $gou->level == 3 || $gou->level == 4) {
                                        if ($gou->isdelete == 0) {
                                ?>
                                    <tr>
                                        <td><?= $no++ ?></td>
                                        ...
                                        ?></td>
                                        <td>
                                            <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#userDetailModal" onclick="showUserDetail('<?= $gou->nama_user ?>', '<?= $gou->level ?>', '<?= $gou->nis ?>', '<?= $gou->nisn ?>')">Detail</button>
                                        </td>
                                    </tr>
                                <?php
                                    }
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="userDetailModalLabel">Detail Guru</h5>
...
<script>
function showUserDetail(name, role, nis, nisn) {
